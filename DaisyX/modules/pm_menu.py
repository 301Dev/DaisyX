...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        ...
        InlineKeyboardButton(
            strings["btn_source"], url="https://t.me/Film_Zones"
        ),
    )
    buttons.add(
        InlineKeyboardButton(strings["btn_channel"], url="https://t.me/CrowdXStrike"),
        InlineKeyboardButton(
            strings["btn_group"], url="https://t.me/CrowdStrikeChat"
        ),
    )
    buttons.add(
        InlineKeyboardButton(
            "☑️ Add Kirito to your group",
            url=f"https://telegram.me/KiritoKazutoBot?startgroup=true",
        )
    )
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/KiritoKazutoBot?start")
    )
    await message.reply(strings["help_header"], reply_markup=button)
